...
def scope_dive(target: str) -> str:
    ...
    prompt = (
        ...
        f"FIRST: Read the credit-trading skill for methodology context:\n"
        f"  - training/_compiled/credit-trading/current/SKILL.md (main skill)\n"
        f"  - training/_compiled/credit-trading/current/references/ (supporting files — "
        f"read whichever the SKILL.md directs you to for this target)\n"
        f"  - If the target is a BDC, also read training/_compiled/bdc-knowledge/v1.0/SKILL.md "
        f"and its references/\n\n"
...
def execute_dive(target: str, web_search_approved: bool = False,
    ...
    prompt = (
        ...
        f"1. Read the credit-trading skill: training/_compiled/credit-trading/current/SKILL.md "
        f"and whichever references/ files it directs you to for this target. "
        f"If this is a BDC, also read training/_compiled/bdc-knowledge/v1.0/SKILL.md and its references/.\n"
