...
def run_morning_briefing(topic: str | None = None) -> str:
    ...
    prompt = (
        ...
        f"Steps: "
        f"1. Apply the credit-trading skill's methodology — it should auto-load when you "
        f"begin the briefing based on topic relevance. "
        ...
        f"6. Draft the daily file at research/briefings/briefing-{today}.md with status: draft, reviewed: false. "
        f"7. Update relevant research/macro/* subfolders with descriptive-prefix snapshots. "
